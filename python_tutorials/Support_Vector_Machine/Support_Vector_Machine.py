...
### Class for Support vector Machine (Custom Class)
class Support_Vector_Machine:
    ...
    def SVM_Fit(self, data):   ### training
        self.data = data
        opt_dict = {}
    ...
    def SVM_Predict(self, features):   ### Testing
        classification = np.sign(np.dot(np.array(features),self.w)+ self.b)   ### X.W + B
